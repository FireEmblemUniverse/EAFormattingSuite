...
main = do
    ...
    case cinnamonRollEither of
        Left error -> Prelude.putStr $ makeError toStdOut error
                ...
                formattedMug <- copySectionFromTo 2 0 paletteIndices 0 0 8 4 emptyMugImage >>= --red
                ...
                if outputImages
                  then do
                    case encodePalettedPng properlyTransparentPalette properlyTransparentMug of
                      ...
                      Right inds -> do
                        ...
                        hClose outputPng
                    case encodePalettedPng properlyTransparentPalette properlyTransparentFrames of
                      Left err -> Prelude.putStr $ makeError toStdOut err
                      Right inds -> do
